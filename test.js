...
var gameStart = function() {
	...
	drawBall = function drawBall() {
		...
		if (gameStartSwitch === true) {
			var canvasElement = document.getElementById('musicGame');
	...
	setInterval('drawBall()', gameFrequency);
};
...
setInterval('smallBallAddJudge()', smallBallAddFrequency);
